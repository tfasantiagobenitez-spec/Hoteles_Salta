      ...
      <HashRouter>
        <Layout>
          <Routes>
            ...
            <Route path="/profitability" element={<Placeholder title="Rentabilidad y Resultado" />} />
            <Route path="/operations" element={<OperationalKPIs />} />
            <Route path="/benchmark" element={<Placeholder title="Comparativo (Benchmark)" />} />
            <Route path="/risk" element={<Placeholder title="Caja y Riesgo" />} />
